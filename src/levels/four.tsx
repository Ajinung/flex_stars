...
const Four = () => {
  ...
  const ideal_style1 = "justify-content:space-between;";
    ...
    <div className="w-screen lg:flex flex-row-reverse">
      ...
      <div className="w-full pb-12 lg:h-screen relative bg-[#ffde22]">
        <div>
          <Instructions
            level={4}
            first="Now the circles on the edges have drifted further to the sides, increasing the space between them. Use justify-content. This time, the circles have equal spacing between them."
            second=""
          />
