...
const TwentyFour = () => {
  ...
  const ideal_style2 = "flex-wrap:wrap-reverse;";
  const ideal_style3 = "justify-content:center;";
  const ideal_style4 = "align-content:space-between;";
          ...
          <div className="w-11/12 md:mr-[30px] m-auto py-[20px] flex flex-col gap-[10px] bg-[#d1b61c] rounded-xl">
            ...
            <div className="flex justify-center">
              {yes ? (
                <button
                  onClick={() => {
                    navigate("/finfinfinfinfinfinfinfin");
                  }}
