...
const Seven = () => {
  ...
  const ideal_style1 = "justify-content:space-around;";
  const ideal_style2 = "align-items:flex-end;";
  const ideal_style3 = "align-items:end;";
    ...
    <div className="w-screen lg:flex flex-row-reverse">
      ...
      <div className="w-full pb-12 lg:h-screen relative bg-[#ffde22]">
        <div>
          <Instructions
            level={7}
            first="The stars need to get across again, this time to some circles with plenty of space around them. Use a combination of justify-content and align-items."
            second=""
          />
